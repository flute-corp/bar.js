  ...
  <v-form>
    ...
    <p class="text-xs-center">
      <g-signin-button
              ...
              @success="onSignInGSuccess"
              @error="onSignInGError">
        <div>
      ...
      <fb-signin-button
              ...
              @success="onSignInFSuccess"
              @error="onSignInFError">
        <div>
...
<script>
  ...
  export default {
    ...
    methods: {
      onSignInGSuccess: function (googleUser) {
...
<style scoped>
  .fb-signin-button, .g-signin-button {
    margin-left:    10px;
    margin-right:   10px;
    margin-top:     20px;
  ...
  .fb-signin-button span, .g-signin-button span {
    font-size:      14px;
    line-height:    32px;
    letter-spacing: 0.21px;
  }

  .fb-signin-button div, .g-signin-button div {
    padding: 5px;
    float:   left;
  }
